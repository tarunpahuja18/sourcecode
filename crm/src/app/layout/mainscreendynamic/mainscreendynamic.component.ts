...
import { AddContactService } from '../mainscreen/mainscreen.service';
...
@Component({
  selector: 'app-mainscreendynamic',
  templateUrl: './mainscreendynamic.component.html',
  styleUrls: ['./mainscreendynamic.component.scss'],
  providers: [AddContactService, AlertService],
  animations: [slideToRight()],
  encapsulation: ViewEncapsulation.None

})
export class MainscreenDynamicComponent {
  loading = false;
  model: any = {};
  contactId: string;
